            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  ...
                  the baseline. The more active you are, the higher your TDEE
                  will be, but it all starts with your BMR. The BMR (Basal
                  Metabolic Rate) formula is calculated using the Mifflin-St
                  Jeor Equation, which is one of the most accurate methods:
                  <br></br>For Men: BMR = (10 x weight in kg) + (6.25 × height
                  in cm) - (5 × age in years) + 5<br></br>For Women: BMR = (10 x
                  weight in kg) + (6.25 × height in cm) - (5 × age in years) -
                  161
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  ...
                  activity level. Think of it like your body's fuel budget. If
                  you eat this many calories, your weight stays the same.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
                <AlertDialogAction>Continue</AlertDialogAction>
